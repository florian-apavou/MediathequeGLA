...
<div class="container">
  <div class="row">
    ...
    <a class="btn btn-secondary gestMediaBox col-lg-5 mx-1 my-1 d-flex justify-content-center align-items-center" href="gestMedias.php"><i class="fas fa-book fa-5x mx-2"></i><span>Ajout de Médias</span></a>
  </div>
  <div class="row">
    <a class="btn btn-primary gestClientBox col-lg-5 mx-1 my-1 d-flex justify-content-center align-items-center" href="gestClients.php"><i class="fas fa-address-book fa-5x mx-2"></i><span>Gestion des comptes Clients</span></a>
